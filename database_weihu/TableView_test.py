...
class Ui_dataBaseForm(object):
    def setupUi(self, dataBaseForm):
        ...
        self.date_end.setDateTime(QtCore.QDateTime(QtCore.QDate(2021, 12, 23), QtCore.QTime(2, 7, 11)))
    ...
    def retranslateUi(self, dataBaseForm):
        ...
        dataBaseForm.setWindowTitle(_translate("dataBaseForm", "TableView数据库视图"))
        ...
        self.db_writ.setText(_translate("dataBaseForm", "1 0"))
